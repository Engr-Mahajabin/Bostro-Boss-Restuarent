            ...
            <div className='bg-gray-100 p-12'>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-control my-6 w-full">
                        ...
                        <br />
                        <textarea {...register("recipe", { required: true })} className="textarea w-full h-36" placeholder="Recipe Details"></textarea>
                    </div>
                    ...
                    {/* Button */}
                    <div className='my-6'>
                        <button className="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg xl:btn-xl bg-orange-400 text-white">Add Item
